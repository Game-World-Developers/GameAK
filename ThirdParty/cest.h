...
static inline cest_value_t cest_value(unsigned int v) { return cest_int((long long)v); }
static inline cest_value_t cest_value(long v) { return cest_int(v); }
static inline cest_value_t cest_value(unsigned long v) { return cest_int((long long)v); }
static inline cest_value_t cest_value(long long v) { return cest_int(v); }
static inline cest_value_t cest_value(unsigned long long v) { return cest_int((long long)v); }
...
#else
#  define CEST_FORK_TEST(...) do { __VA_ARGS__; } while(0)
#endif
...
#define it(name, ...) test(name, __VA_ARGS__)
